...
my10_dataset =dataset_base.copy({
    'name': 'LIEF10_Dataset',
    'train_images': './yolact_edge/data/yolactedge10/train/output/',
    'train_info':   './yolact_edge/data/yolactedge10/train/output/annotations.json',
    'valid_images': './yolact_edge/data/yolactedge10/validation/output/',
    'valid_info':   './yolact_edge/data/yolactedge10/validation/output/annotations.json',
    'class_names': MY10_CLASSES,
    'label_map': MY10_LABEL_MAP
})
...
my10_yolact_edge_config = yolact_base_config.copy({
    'name':'my10_yolact_edge',
    'dataset': my10_dataset ,
    'num_classes': len(my10_dataset.class_names) + 1,
    'backbone': resnet50_backbone.copy({
        'selected_layers': list(range(1, 4)),
...
# Default config
cfg = my10_yolact_edge_config.copy()
